...
The data frame has five columns: state, 2020 vote (biden v. trump), and the following columns for 2021: per pupil, gdp growth, population change
...
The blue line seems to indicate that as population grew, gdp grew. I am not really seeing much/making sense of the dots beyond a cluster in the middle. It looks like a circle. 
...
**Answer**
I see a blob of dots, and a line indicating a downward pattern of which I am not seeing very clearly. 
...
I am having a difficult time understanding how to read this table. 
...
**Answer**
I see the p-value which brings back vague memories of my statistics class in undergrad back in the day.
...
I see a higher p-value at .6795 and I cannot remember what that means. 
...
**Answer**
It would appear that the states that voted for Trump saw a larger population growth than states that voted for Biden, and these states spent less on education and had smaller gdp growths. 
...
**Answer**
The p-value is greater than .05, and therefore not statistically significant. 
...
**Answer**
Both the p-value (.0001289) and t value (4.2494) are statistically significant, meaning that there is a pattern between states that voted for Biden v. Trump and education spending. 
